...
```bash
git clone https://github.com/Clube-de-Programacao-IFPAR/solucoes-obi-ifpar-front.git
cd solucoes-obi-ifpar-front
```
...
Este repositório contém o código da interface web que está sendo construída colaborativamente pelos membros do clube.
