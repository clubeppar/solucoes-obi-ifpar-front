      ...
      <div className="grid grid-cols-13 w-3/4">
        <div className="col-span-6 grid grid-rows-4 items-center justify-items-end text-end">
          <div className="min-w-fit">
            ...
            <p className="text-gray-300">{leftSteps[0].description}</p>
          </div>
          ...
          <div className="min-w-fit">
            ...
            <p className="text-gray-300">{leftSteps[1].description}</p>
          </div>
        ...
        <div className="col-span-6 grid grid-rows-4 items-center justify-items-start">
          ...
          <div className="min-w-fit">
            ...
            <p className="text-gray-300">{rightSteps[0].description}</p>
          </div>
          ...
          <div className="min-w-fit">
            ...
            <p className="text-gray-300">{rightSteps[1].description}</p>
          </div>
        </div>
      </div>
    </div>
