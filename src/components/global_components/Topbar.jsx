  ...
  return (
    <header className="grid grid-cols-3 items-center px-3 z-10 w-full">
      ...
      <div className="flex justify-center">
        <button className="list-item">Inicio</button>
      ...
      <div className="flex justify-end items-center gap-2">
        ...
        <button
          className="btn-info-3d h-9 hidden sm:flex items-center gap-2 cursor-pointer"
          onClick={() =>
            (window.location.href =
              "https://github.com/G-Aleixo/solucoes-obi-ifpar")
          }
        >
          Github
        </button>
